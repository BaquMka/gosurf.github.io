$(function () {
    ...
    $('.header__slider').slick({
        infinite: true,
        fade: true,
        prevArrow: '<img class="slider-arrows slider-arrows__left" src="./img/header/arrowsleft.svg" alt="arrowsright"></img>',
        nextArrow: '<img class="slider-arrows slider-arrows__right" src="./img/header/arrowsright.svg" alt="arrowsright"></img>',
